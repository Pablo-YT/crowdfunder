...
from .views import root, project_view, project_create, project_show, login_view, logout_view, signup, catagorie_search, backer_view
...
urlpatterns = [
    ...
    path('backer/', backer_view, name='backer_view')
]
